package com.bonsai.admin.user;

import com.bonsai.admin.FileUploadUtil;
import com.bonsai.common.entity.Role;
...
import com.bonsai.admin.user.export.UserCsvExporter;
import com.bonsai.admin.user.export.UserExcelExporter;
import com.bonsai.admin.user.export.UserPdfExporter;
...
//	}
	...
	@GetMapping("/users")//localhost:8082/bonsaiAdmin/users
	public String listFirstPage(Model model) {
		return defaultRedirectURL;
	}

	@GetMapping("/users/page/{pageNum}")//localhost:8082/bonsaiAdmin/users/page/1?sortField=firstName&sortDir=asc -->1 là giá trị có thể thay đổi -->phải dùng @PathVariable(name = "pageNum") int pageNum để nó tự động gán giá trị vào biến pageNum
